...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        public Engine(IRenderer renderer, IUserInterface userInterface, int speedTime) : 
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            int i = 0;
            for (i = 0; i < this.allObjects.Count(); i++)
            {
                if (this.allObjects[i] is Racket)
                    break;
            }
            if (i != this.allObjects.Count())
            {
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(this.SpeedTime);
